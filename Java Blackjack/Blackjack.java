...
public class Blackjack {
    ...
    public static void printResult(Player dealer, Player user) {
        ...
        if ((user.getHandValue() == dealer.getHandValue()) || (user.hasBlackjack() == true && dealer.hasBlackjack() == true)) {
            System.out.println("Push!");
        }
        else if (user.hasBlackjack() == true && dealer.hasBlackjack() == false) {
            System.out.println("Blackjack! Congrats, " + user + "!");
        } 
        else if (dealer.hasBlackjack() == true && user.hasBlackjack() == false) {
            System.out.println("You lose, " + user + ".");
        }
